...
<div class="col-12 grid-margin stretch-card">
    <div class="card">
      <div class="card-body">
        ...
        <p class="card-description"> Edit Reward </p>
        <form class="forms-sample" method="POST" action="{{route('rewards.update', $reward->id)}}">
          @csrf
          <input type="hidden" name="_method" value="PATCH">
          <div class="form-group">
            <label for="name">Name</label>
            <input type="text" name="name" class="form-control" id="level" placeholder="Name" value="{{old('name', $reward->name)}}">
            @if ($errors->has('name'))
          ...
          <div class="form-group">
            ...
            <textarea name="description" class="form-control" id="description" cols="30" rows="10" maxlength="254">{{$reward->description}}</textarea>
          ...
          <div class="form-group">
            ...
            <input type="text" name="points_required" class="form-control" id="points_required" placeholder="Points Required" value="{{old('points_required', $reward->points_required)}}">
          ...
          <div class="form-group">
            ...
            <input type="text" name="quantity_available" class="form-control" id="quantity_available" placeholder="Quantity Available" value="{{old('quantity_available', $reward->quantity_available)}}">
  ...
  <script>
    ...
    */
    ...
    const imageSrc = "{{ asset('user/images/reward/' . $reward->image) }}";
