...
<div class="col-12 grid-margin stretch-card">
    <div class="card">
      <div class="card-body">
        ...
        <p class="card-description"> Add Membership </p>
        <form class="forms-sample" method="POST" action="{{route('memberships.store')}}">
          @csrf
          ...
          <div class="form-group">
            ...
            <div class="input-group">
              ...
              <input type="text" name="totalAmount_spent" class="form-control" id="totalAmount_spent" placeholder="Total Amount Spent" value="{{old('totalAmount_spent')}}">
            </div> 
          ...
          <div class="form-group">
            ...
            <div class="input-group">
              ...
              <span class="field-icon input-group-text">%</span>
            </div> 
