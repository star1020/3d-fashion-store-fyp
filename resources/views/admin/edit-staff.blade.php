      ...
      <div class="card-body">
        ...
        <form class="forms-sample" method="POST" action="{{ route('staffs.update', $user->id) }}" >
            ...
            <div class="col-sm-4">
              <div class="form-check">
                <label class="form-check-label">
                  <input type="radio" class="form-check-input" name="roleRadios" id="roleRadios1" value="user"> User </label>
              </div>
            </div>
            <div class="col-sm-5">
              <div class="form-check">
                <label class="form-check-label">
                  <input type="radio" class="form-check-input" name="roleRadios" id="roleRadios2" value="staff" checked> Staff </label>
              </div>
            </div>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <input type="text" name="phoneNum" class="form-control" id="exampleInputPhoneNum" placeholder="Phone No" value="{{old('phoneNum', $user->phoneNum)}}">
